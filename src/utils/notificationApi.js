...
async function apiRequest(url, options = {}) {
  const res = await fetch(url, {
    ...options,
    headers: buildHeaders(options.method !== "GET"),
  });
...
export const fetchNotifications = () =>
  apiRequest(`${API_BASE}/notifications`);

export const fetchUnreadCount = () =>
  apiRequest(`${API_BASE}/notifications/unread-count`);

export const markNotificationRead = (id) =>
  apiRequest(`${API_BASE}/notifications/${id}/read`, { method: "PUT" });

export const markAllNotificationsRead = () =>
  apiRequest(`${API_BASE}/notifications/read-all`, { method: "PUT" });

export const deleteNotification = (id) =>
  apiRequest(`${API_BASE}/notifications/${id}`, { method: "DELETE" });

export const clearAllNotifications = () =>
  apiRequest(`${API_BASE}/notifications/clear-all`, { method: "DELETE" });